...
project = diced.__name__
author = re.match("(.*) <.*>", diced.__author__).group(1)
year = datetime.date.today().year
copyright = "{}, {}".format("2024" if year == 2024 else "2024-{}".format(year), author)

# extract the semantic version
semver = semantic_version.Version.coerce(diced.__version__)
...
doc_lines = diced.__doc__.splitlines()
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/althonos/diced",
            "icon": "fa-brands fa-github",
        },
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/diced",
    ...
    "switcher": {
        "json_url": "https://diced.readthedocs.io/en/latest/_static/switcher.json",
